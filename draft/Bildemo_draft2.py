...
def scrape_cars(url, start_date, end_date, current_page, result_text, excel_name_entry):
    car_list = []
...
def run_scraper():
    try:
        ...
        result = scrape_cars(main_url, start_date, end_date, 1, result_text, excel_name_entry)
...
mot_date_label = tk.Label(app, text="Ange Senast Besiktning:", font=("Arial", 15), bg="#FFFFFF", fg="#000000", padx=10, pady=1)
mot_date_label.pack(pady=1)

start_date_label = tk.Label(app, text="Start Datum (YYYY-MM-DD):", font=("Arial", 14), bg="#FFFFFF", fg="#000000", padx=10, pady=1)
start_date_label.pack(pady=1)

start_date_entry = tk.Entry(app, font=("Arial", 14))
start_date_entry.pack(pady=10)

end_date_label = tk.Label(app, text="Slut Datum (YYYY-MM-DD):", font=("Arial", 14), bg="#FFFFFF", fg="#000000", padx=10, pady=1)
end_date_label.pack(pady=1)

end_date_entry = tk.Entry(app, font=("Arial", 14))
end_date_entry.pack(pady=10)

excel_name_label = tk.Label(app, text="Excel File Name:", font=("Arial", 15), bg="#FFFFFF", fg="#000000", padx=10, pady=1)
excel_name_label.pack(pady=1)

excel_name_entry = tk.Entry(app, font=("Arial", 14))
excel_name_entry.pack(pady=10)

scrape_button = tk.Button(app, text="Hitta bilar", command=run_scraper, font=("Arial", 20), fg="#000000", bg="#064789", padx=10, pady=5)
scrape_button.pack(pady=10)

result_text = tk.Text(app, height=30, width=70, state=tk.DISABLED, wrap="word", font=("Arial", 20), fg="#000000", bg="#999999", padx=10, pady=10)
